...
namespace PaymentGateway.request
{
    public class soap : IDisposable
    {
        ...
        internal async Task<object> handleResponse(string responseString, string operation, object returnVariable = null)
        {
            try
            {
                var r = await parseResponse(responseString, operation);
